...
<html lang="en">
  <head>
    ...
    <title>بيانات مراكز الحجر </title>
  ...
  <body>
    ...
    if(request.getParameter("submit")!=null)
    {
     ...
     String sql_qarantina = "INSERT INTO qarantina_centers_t (qarantina_name,qarantina_address,qarantina_tele,qarantina_lat,qarantina_long) values (?,?,?,?,?)";
     ...
     pst=con.prepareStatement(sql_qarantina);
...
alert("تمت اضافة المركز بنجاح ! ");
    ...
    <div class="landing-text text-center">
      <h5 style="padding: 2.5%;">: التعديل على بيانات مراكز الحجر </h5>
    </div>
        ...
        <div class="col-sm-4">
            ...
            <form method="POST" action="#" id="add_qarantina" name="add_qarantina">
              <div class="form-group">
                ...
                <input type="text" name="qarantina_name" class="form-control" id="qarantina_name" placeholder="اسم المركز" required style="margin-bottom: 40px; text-align: right" >
              </div>
              <div class="form-group">
                <label id="label_style"> عنوان المركز</label>
                <input type="text" name="qarantina_address" class="form-control" id="qarantina_name" placeholder="عنوان المركز" size="20px" required  style="margin-bottom: 40px; text-align: right">
              </div>
              <div class="form-group">
                <label id="label_style"> هاتف المركز</label>
                <input type="text" name="qarantina_tele" class="form-control" id="qarantina_name" placeholder="هاتف المركز" size="20px" required  style="margin-bottom: 40px; text-align: right">
              </div>
              <div class="form-group">
                <label id="label_style"> (احداثيات المركز (خط الطول </label>
                <input type="text" name="qarantina_lat" class="form-control" id="qarantina_name" placeholder="احدائيات المركز" size="20px" required style="margin-bottom: 40px; text-align: right" >
              </div>
              <div class="form-group">
                <label id="label_style"> (احداثيات المركز (خط العرض</label>
                <input type="text" name="qarantina_long" class="form-control" id="qarantina_name" placeholder="احدائيات المركز" size="20px" required style="margin-bottom: 40px; text-align: right" >
              </div>
              <br><br>
              <div class="form-group">
            ...
            <table class="table table-fixed table-striped " id="table_css" class="tableBodyScroll">
              ...
              <tbody>
                <% 
                    ...
                    String query = "select * from qarantina_centers_t";
                    ...
                    %>
                  <tr>
                        <td ><%=rs.getString("qarantina_name") %></td> 
                        <td ><%=rs.getString("qarantina_address") %></td>  
                        <td ><%=rs.getString("qarantina_tele") %></td> 
                        <td ><%=rs.getString("qarantina_lat") %></td> 
                        <td ><%=rs.getString("qarantina_long") %></td> 
                        <td><a href="qarantina_update.jsp?id=<%=id%>" class="edit" title="تعديل" data-toggle="tooltip"><i class="fa fa-sun"></i></a> </td>
                        <td><a href="qarantina_delete.jsp?id=<%=id%>" class="delete" title="حذف" data-toggle="tooltip" ><i class="fa fa-trash-alt"></i></a> </td>
                  </tr>
                  <%
                      }
                   %>
